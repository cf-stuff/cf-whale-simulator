...
export const FIGHTER = {
  ...
  rugalz: {
    ...
    bmv: [10, 10, 10],
    mastery: SKILL_TYPE.taijutsu.name
  },
  lionDancer: {
    name: "Lion Dancer",
    evoName: "Lion Dancer",
    ...
    growthRate: [1.75, 1.75, 1.75],
    bmv: [10, 10, 10],
    mastery: SKILL_TYPE.genjutsu.name
  },
  pumpkin: {
    name: "Pumpkin",
    evoName: "E·Pumpkin",
  ...
  kaneki: {
    ...
    bmv: [9, 11, 15],
    mastery: SKILL_TYPE.ninjutsu.name
  },
  erza: {
    name: "Erza",
    evoName: "E·Erza",
