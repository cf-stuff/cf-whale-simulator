...
function renderTotem(ctx, playerTotem, options, promises) {
...
function renderFighterDetails(ctx, playerFighter, options, promises) {
...
function renderPetDetails(ctx, playerPet, options, promises) {
