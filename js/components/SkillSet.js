...
const SkillSet = ({ skillsetNumber, skills, setSkill }) => {
  ...
  <div class="skillset">
    <div class="skill-container skills">
      <div class="skill-frame phy-container text-center" ondragover=${e => e.preventDefault()} ondrop=${e => setSkill(0, e.dataTransfer.getData("id"))}>
    ...
    <div class="skill-container skills pt-3">
      ${skills.slice(1).map((skill, i) => html`<div class="skill-frame text-center"
