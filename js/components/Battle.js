...
const Battle = () => {
  ...
  <div class="row">
    ...
    including but not limited to: Strong Wine and Shield Wall Burst temporary stat decreases; Different level fighter skills depending on fighter level.</span>
  </div>
  `;
}
